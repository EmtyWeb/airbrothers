<section id="news_create">
    <div class="news_create">
        <h1>Портфолио / Меню / <span>Добавление сайт</span></h1>
        <form method="post" id="create_form" action="<?php echo URL;?>account/site_create" enctype="multipart/form-data">
            ...
            <div><input type="text" class="c_title" name="link"
                   placeholder="Ccылка на сайт" value="<?=$edit['site_link'];?>" /></div>
            <div class="form_img">
                <label for="img">Загрузить иконку</label><input type="file" name="img" value="Обзор" required/>
            </div>
            <div class="form_img">
                <label for="picture">Загрузить контент</label><input type="file" name="picture" required/>
            </div>
