<section id="news_create">
    <div class="news_create">
        ...
        <form method="post" id="create_form" action="<?php echo URL;?>account/update_site/<?=$edit['site_id']?>" enctype="multipart/form-data">
            <div class="c_first"><label for="title">Название</label></div>
            <div><input type="text" class="c_title" name="title"
                        placeholder="Название дизайна" value="<?=$edit['site_title'];?>" /></div>
